...
public class MasterRenderer {
	...
	private static final float FAR_PLANE = 1000; // How far we can see
	...
	public static Map<TexturedModel, List<Entity>> normalMapEntities = new HashMap<TexturedModel, List<Entity>>();
